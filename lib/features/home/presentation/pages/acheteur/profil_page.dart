      ...
      builder: (_) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            Text(
              'Cette action est irréversible : votre profil et vos données personnelles seront supprimés. Si vous avez des commandes en cours, vous devrez d\'abord les finaliser.',
              style: GoogleFonts.dmSans(
                fontSize: 15,
                fontWeight: FontWeight.w400,
                color: _C.sub,
