...
import '../../../../favoris/presentation/pages/favoris_page.dart';
import '../../../../avis/presentation/pages/mes_avis_page.dart';
...
class _ProfilPageState extends State<ProfilPage>
  ...
  Future<void> _loadStats() async {
    try {
      ...
      if (!mounted) return;
      setState(() {
        _nbCommandes = commandes.length;
        _nbFavoris   = favoris.length;
        _nbPanier    = sl<PanierService>().nombreArticles;
      });
    } catch (_) {/* on garde les valeurs par défaut (0) */}
  }
    ...
    showDialog(
      ...
      builder: (_) => _LogoutDialog(
        onConfirm: () {
          ...
          // Consultation libre : après déconnexion, on revient à l'accueil
          // client (invité), pas à la page de connexion.
          ...
          slivers: [
            ...
            SliverToBoxAdapter(
              child: Container(
                ...
                child: _estConnecte ? _buildConnecteContent() : _buildInviteContent(),
              ),
            ),
          ],
        ),
  ...
  // ── Contenu invité (client non connecté) ────────────────────────────────────
          ...
          child: Column(
            children: [
              Container(
                ...
                child: const Icon(Icons.person_outline_rounded, color: _C.green, size: 32),
              ),
              const SizedBox(height: 16),
              ...
              Text(
                ...
                'retrouver vos favoris et finaliser votre panier.',
                textAlign: TextAlign.center,
                style: GoogleFonts.dmSans(fontSize: 13, height: 1.5, color: _C.sub),
              ),
                    ...
                    child: Center(
                      child: Text('Se connecter',
                          style: GoogleFonts.dmSans(
                              fontSize: 14.5, fontWeight: FontWeight.w700, color: _C.white)),
                    ),
                  ),
                ),
              ),
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Row(
                        children: [
                          // Bouton retour pour quitter la page profil
                    ...
                    children: [
                      Stack(
                        children: [
                          ...
                          // Badge vérifié (client connecté uniquement)
                          if (_estConnecte)
                            Positioned(
                              bottom: -2, right: -2,
                              child: Container(
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              _estConnecte ? _email : 'Bienvenue sur Yobante Boutique',
                              style: GoogleFonts.dmSans(
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    _estConnecte ? (_user?.role ?? 'Acheteur') : 'Invité',
                                    style: GoogleFonts.dmSans(
                  ...
                  Row(
                    children: [
                      Expanded(child: _buildStatBox(_nbCommandes.toString(), 'Commandes')),
                      const SizedBox(width: 8),
                      Expanded(child: _buildStatBox(_nbFavoris.toString(), 'Favoris')),
                      const SizedBox(width: 8),
                      Expanded(child: _buildStatBox(_nbPanier.toString(), 'Panier')),
                    ],
                  ),
                ],
              ),
  ...
  // ── Espace Vendeur (accès aux fonctionnalités vendeur) ─────────────────────
  Widget _buildEspaceVendeurCard() {
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: const LinearGradient(
            colors: [Color(0xFF1A1A1A), _C.green],
            begin: Alignment.topLeft,
            end: Alignment.bottomRight,
          ),
          borderRadius: BorderRadius.circular(20),
          boxShadow: [
            BoxShadow(color: _C.green.withOpacity(0.25), blurRadius: 16, offset: const Offset(0, 6)),
          ],
        ),
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.storefront_rounded, color: gold, size: 22),
            ),
            const SizedBox(width: 14),
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 3),
                  Text(
                    'Demandes de publication, ventes & stock',
                    style: GoogleFonts.dmSans(fontSize: 11.5, color: Colors.white.withOpacity(0.7)),
                  ),
                ],
              ),
            ),
            Container(
              ...
              child: const Icon(Icons.arrow_forward_rounded, color: goldDark, size: 18),
            ),
          ],
        ),
      ),
  ...
  // ── Mon activité (favoris, avis, notifications, messages, signalements) ────
    ...
    return _SectionCard(
      ...
      children: [
        ...
        _RowItem(
          ...
          label: 'Mes avis',
          sub: 'Avis laissés sur des boutiques',
          onTap: () => Navigator.of(context).push(
        ...
        _RowItem(
          ...
          label: 'Messages',
          sub: 'Vos conversations avec les vendeurs',
          onTap: () => Navigator.of(context).push(
        ...
        _RowItem(
          ...
          sub: 'Contenus que vous avez signalés',
          onTap: () => Navigator.of(context).push(
            MaterialPageRoute(builder: (_) => const MesSignalementsPage()),
          ),
          isLast: true,
        ),
      ],
    ...
    final confirme = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        content: const Text(
          ...
          'personnelles seront supprimés. Si vous avez des commandes en '
          'cours, vous devrez d\'abord les finaliser.',
        ),
        actions: [
          TextButton(
